      ...
      <AnimatePresence mode="wait">
        {sidebarOpen && (
          <motion.aside
            ...
            className="w-64 bg-zinc-50 border-r border-zinc-200/80 flex flex-col h-screen shrink-0 select-none z-30 font-sans dark:bg-zinc-900 dark:border-zinc-800"
          >
